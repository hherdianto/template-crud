      ...
      <div class="col-md-12" style="margin-bottom:15px;">
        ...
        <?php else:?>
          <div class="row">
            ...
            <div class="col-md-5 text-right">
              <button class="btn btn-danger btn-sm hapus-aktif" ><i class ="fa fa-1x fa-fw fa-trash"></i></button>
              <button class="btn btn-info btn-sm ubah-aktif" >Ubah</button>
              <button class="btn btn-success btn-sm cetak-aktif" data-id-visit="<?= $v['id_visit'] ?>" data-id-reg="<?= $v['id_reg'] ?>">Cetak</button>
            </div>
...
<script type="text/javascript">
  ...
  $('.cetak-aktif').on("click",function(e)
  {
    ...
    aktif_pdf = window.open('<?php echo base_url();?>'+class_name+'/view_pdf?status=aktif&id_visit=' + id_visit);
  });
